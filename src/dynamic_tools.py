...
🕐 Last updated: {current['last_updated']}
        ...
        logger.error(error_msg)
        return f"Sorry, I received unexpected data format from the weather service."
    except Exception as e:
        logger.error(f"Unexpected error in get_current_weather: {e}")
        return f"An unexpected error occurred while fetching weather information."
...
• 1000 {base_currency.upper()} = {rate * 1000:.2f} {target_upper}
        ...
        logger.info(f"Successfully retrieved exchange rate")
